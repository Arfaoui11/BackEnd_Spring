...
import com.spring.pidev.repo.ICandidacyRepository;
import com.spring.pidev.exception.OAuth2AuthenticationProcessingException;
import com.spring.pidev.exception.UserAlreadyExistAuthenticationException;
import com.spring.pidev.security.oauth2.user.OAuth2UserInfo;
import com.spring.pidev.security.oauth2.user.OAuth2UserInfoFactory;
